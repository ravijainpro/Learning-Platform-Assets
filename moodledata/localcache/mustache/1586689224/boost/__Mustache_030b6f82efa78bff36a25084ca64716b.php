...
class __Mustache_030b6f82efa78bff36a25084ca64716b extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                ...
                'element' => array($this, 'block1a73cfd700c421c5308d43407f0434f1'),
            ));
...
';
    ...
    public function block1a73cfd700c421c5308d43407f0434f1($context)
    {
        $indent = $buffer = '';
