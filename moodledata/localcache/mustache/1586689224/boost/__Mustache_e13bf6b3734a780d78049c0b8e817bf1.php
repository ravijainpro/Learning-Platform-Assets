...
class __Mustache_e13bf6b3734a780d78049c0b8e817bf1 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionD44353b62d02e89a12abab80aae4a7e0($context, $indent, $value);
        $buffer .= $indent . '            </tr>
';
        $buffer .= $indent . '        </thead>
';
...
';
        ...
        $buffer .= $this->sectionA982d7e7a8cbe930b95d4f2a2034efac($context, $indent, $value);
        $buffer .= $indent . '        </tbody>
';
        $buffer .= $indent . '    </table>
';
...
';
    ...
    private function sectionD44353b62d02e89a12abab80aae4a7e0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                <th class="header text-xs-center" aria-label="';
...
';
    ...
    private function section0648f68eb6a9125d5005ec54ae848b36(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionA982d7e7a8cbe930b95d4f2a2034efac(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section0648f68eb6a9125d5005ec54ae848b36($context, $indent, $value);
                // 'postpadding' section
